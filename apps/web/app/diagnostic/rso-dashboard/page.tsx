...
export default function Page() {
  const gate = useFeatureGate('rso-dashboard');
  if (gate.locked) return <FeatureLockedBlock gate={gate} />;
  const { rows, total, loading, page, setPage } = useList('/diagnostic/rso-dashboard');
  ...
  return (
    <div style={{ padding: 24, maxWidth: 1400, margin: '0 auto' }}>
      <PageHeader title="RSO Dashboard" subtitle="Radiation Safety · Dose Tracking · AERB Compliance · Incidents" />
