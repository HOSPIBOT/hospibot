...
export default function Page() {
  const gate = useFeatureGate('holter-allocation');
  if (gate.locked) return <FeatureLockedBlock gate={gate} />;
  const { rows, total, loading, page, setPage } = useList('/diagnostic/holter-allocation');
  ...
  return (
    <div style={{ padding: 24, maxWidth: 1400, margin: '0 auto' }}>
      <PageHeader title="Holter Allocation" subtitle="Device Tracking · 24/48/72h Studies · Return Management" />
