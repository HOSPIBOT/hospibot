...
export default function Page() {
  const gate = useFeatureGate('population-health');
  if (gate.locked) return <FeatureLockedBlock gate={gate} />;
  const { rows, total, loading, page, setPage } = useList('/diagnostic/population-health');
  ...
  return (
    <div style={{ padding: 24, maxWidth: 1400, margin: '0 auto' }}>
      <PageHeader title="Population Health" subtitle="Cohort Analytics · Risk Stratification · Trend Dashboards" />
