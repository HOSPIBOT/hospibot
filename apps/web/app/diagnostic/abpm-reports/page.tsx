...
export default function Page() {
  const gate = useFeatureGate('abpm-reports');
  if (gate.locked) return <FeatureLockedBlock gate={gate} />;
  const { rows, total, loading, page, setPage } = useList('/diagnostic/abpm-reports');
  ...
  return (
    <div style={{ padding: 24, maxWidth: 1400, margin: '0 auto' }}>
      <PageHeader title="ABPM Reports" subtitle="Ambulatory BP · Diurnal Patterns · Dipping Profiles · BP Loads" />
