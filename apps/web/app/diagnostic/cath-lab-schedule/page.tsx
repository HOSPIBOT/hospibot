...
export default function Page() {
  const gate = useFeatureGate('cath-lab-schedule');
  if (gate.locked) return <FeatureLockedBlock gate={gate} />;
  const { rows, total, loading, page, setPage } = useList('/diagnostic/cath-lab-schedule');
  ...
  return (
    <div style={{ padding: 24, maxWidth: 1400, margin: '0 auto' }}>
      <PageHeader title="Cath Lab Schedule" subtitle="Procedure Scheduling · Consumables · Post-Procedure Reports" />
