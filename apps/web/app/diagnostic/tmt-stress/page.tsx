...
export default function Page() {
  const gate = useFeatureGate('tmt-stress');
  if (gate.locked) return <FeatureLockedBlock gate={gate} />;
  const { rows, total, loading, page, setPage } = useList('/diagnostic/tmt-stress');
  ...
  return (
    <div style={{ padding: 24, maxWidth: 1400, margin: '0 auto' }}>
      <PageHeader title="TMT / Stress Test" subtitle="Bruce Protocol · ECG Overlays · Interpretation Templates" />
