...
export default function Page() {
  const gate = useFeatureGate('urodynamics');
  if (gate.locked) return <FeatureLockedBlock gate={gate} />;
  const { rows, total, loading, page, setPage } = useList('/diagnostic/urodynamics');
  ...
  return (
    <div style={{ padding: 24, maxWidth: 1400, margin: '0 auto' }}>
      <PageHeader title="Urodynamic Studies" subtitle="Cystometrogram · Pressure-Flow · Uroflowmetry · EMG" />
