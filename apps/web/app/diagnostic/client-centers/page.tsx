...
export default function Page() {
  const gate = useFeatureGate('client-centers');
  if (gate.locked) return <FeatureLockedBlock gate={gate} />;
  const { rows, total, loading, page, setPage } = useList('/diagnostic/client-centers');
  ...
  return (
    <div style={{ padding: 24, maxWidth: 1400, margin: '0 auto' }}>
      <PageHeader title="Client Centers" subtitle="Tele-Radiology Clients · Contracts · Volume Tracking" />
