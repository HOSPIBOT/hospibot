...
export default function Page() {
  const gate = useFeatureGate('hub-spoke');
  if (gate.locked) return <FeatureLockedBlock gate={gate} />;
  const { rows, total, loading, page, setPage } = useList('/diagnostic/hub-spoke');
  ...
  return (
    <div style={{ padding: 24, maxWidth: 1400, margin: '0 auto' }}>
      <PageHeader title="Hub & Spoke Routing" subtitle="Test Routing · Capacity Planning · TAT Optimization" />
