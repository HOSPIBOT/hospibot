...
export default function Page() {
  const gate = useFeatureGate('genetic-counseling');
  if (gate.locked) return <FeatureLockedBlock gate={gate} />;
  const { rows, total, loading, page, setPage } = useList('/diagnostic/genetic-counseling');
  ...
  return (
    <div style={{ padding: 24, maxWidth: 1400, margin: '0 auto' }}>
      <PageHeader title="Genetic Counseling" subtitle="Pre/Post-Test Sessions · Counselor Panel · Session Notes" />
