...
export default function Page() {
  const gate = useFeatureGate('consult-schedule');
  if (gate.locked) return <FeatureLockedBlock gate={gate} />;
  const { rows, total, loading, page, setPage } = useList('/diagnostic/consult-schedule');
  ...
  return (
    <div style={{ padding: 24, maxWidth: 1400, margin: '0 auto' }}>
      <PageHeader title="Consult Schedule" subtitle="Post-Checkup Consultations · Auto-Booking · Follow-Up" />
