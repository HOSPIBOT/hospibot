...
import { TrendingUp, ShoppingCart, Wrench, MessageSquare, ArrowUpRight, TrendingUp, Activity } from 'lucide-react';
...
export default function EquipmentDashboard() {
  ...
  const theme = FALLBACK_THEMES['equipment'];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <KpiCard label=Today's Revenue value="₹3.82L" sub="B2B orders" change={"+11%"} icon={TrendingUp} color="#1E40AF" />
        <KpiCard label=Orders Pending value="18" sub="₹12.4L value" change={"+3"} icon={ShoppingCart} color="#94A3B8" />
        <KpiCard label=AMC Due value="7" sub="This week"  icon={Wrench} color="#EF4444" />
        <KpiCard label=WhatsApp Leads value="24" sub="New enquiries" change={"+45%"} icon={MessageSquare} color="#25D366" />
      </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-100 p-5">
          ...
          <ResponsiveContainer width="100%" height={200}>
            <AreaChart data={revenueData} margin={{ top: 0, right: 0, left: -25, bottom: 0 }}>
              <defs>
                <linearGradient id="equipmentGrad" x1="0" y1="0" x2="0" y2="1">
              ...
              <Area type="monotone" dataKey="value" stroke={theme.primaryColor} strokeWidth={2.5} fill="url(#equipmentGrad)" />
            </AreaChart>
          </ResponsiveContainer>
        </div>
