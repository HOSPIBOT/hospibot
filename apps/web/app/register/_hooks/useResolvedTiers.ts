...
const HARDCODED_TIERS: TierFromApi[] = [
  {
    id: 'fb-small', scope: 'family:diagnostic', tierKey: 'small',
    displayName: 'Starter',
  ...
  {
    id: 'fb-medium', scope: 'family:diagnostic', tierKey: 'medium',
    displayName: 'Growth',
  ...
  {
    id: 'fb-large', scope: 'family:diagnostic', tierKey: 'large',
  ...
  {
    id: 'fb-enterprise', scope: 'family:diagnostic', tierKey: 'enterprise',
