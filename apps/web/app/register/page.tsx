...
const SUBS: Record<PortalSlug, {slug:string;name:string;icon:string;popular?:boolean}[]> = {
  ...
  diagnostic:[
    ...
    {slug:'sample-collection-center',name:'Sample Collection Center',icon:'💉'},
    {slug:'home-sample-collection',name:'Home Sample Collection',icon:'🏠',popular:true},
    ...
    {slug:'pet-scan-center',name:'PET Scan Center',icon:'⚛️'},
