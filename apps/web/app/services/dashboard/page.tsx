...
import { FileText, Users, AlertCircle, MessageSquare, ArrowUpRight, TrendingUp, Activity } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <KpiCard label=Active Contracts value="84" sub="₹48L value" change={"+5"} icon={FileText} color="#334155" />
        <KpiCard label=Staff Deployed value="312" sub="Across 28 sites" change={"+18"} icon={Users} color="#14B8A6" />
        <KpiCard label=Open Tickets value="23" sub="4 urgent"  icon={AlertCircle} color="#EF4444" />
        <KpiCard label=WhatsApp Updates value="156" sub="Client communications" change={"+12%"} icon={MessageSquare} color="#25D366" />
      </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-100 p-5">
          ...
          <ResponsiveContainer width="100%" height={200}>
            <AreaChart data={revenueData} margin={{ top: 0, right: 0, left: -25, bottom: 0 }}>
              ...
              <Area type="monotone" dataKey="value" stroke={theme.primaryColor} strokeWidth={2.5} fill="url(#servicesGrad)" />
            </AreaChart>
          </ResponsiveContainer>
        </div>
