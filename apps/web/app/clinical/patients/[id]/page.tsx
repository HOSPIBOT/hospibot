...
import {
  ...
  AlertTriangle, CheckCircle2, Clock, RefreshCw, Loader2, Shield,
} from 'lucide-react';
          ...
          {tab === 'prescriptions' && (
            <div className="space-y-3">
              {(!p.prescriptions || p.prescriptions.length === 0) ? (
                ...
                <div key={rx.id} className="p-4 rounded-xl border border-slate-100 hover:bg-slate-50 transition-colors">
