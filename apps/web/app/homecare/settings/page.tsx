    ...
    <div className="space-y-5">
      ...
      <div className="bg-white rounded-2xl border border-slate-100 p-6 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          {[{k:'name',l:'Facility Name',p:'Home Care Centre Name'},{k:'phone',l:'Phone',p:'+91 98765 43210'},{k:'email',l:'Email',p:'info@centre.com'},{k:'address',l:'Address',p:'Full address'},{k:'gst',l:'GST Number',p:'22AAAAA0000A1Z5'}].map(f=>(
        ...
        <div className="flex justify-end">
          <button onClick={()=>toast.success('Settings saved!')} className="flex items-center gap-2 text-white text-sm font-semibold px-5 py-2.5 rounded-xl hover:opacity-90" style={{background:'#6B21A8'}}>
