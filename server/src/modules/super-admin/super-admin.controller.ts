import {
  ...
  Param, Query, Body, Req, UseGuards, HttpCode, HttpStatus,
} from '@nestjs/common';
...
export class SuperAdminController {
  ...
  @Get('gateway-charges')
  @ApiOperation({ summary: 'Get payment gateway fee configuration' })
  ...
  @ApiOperation({ summary: 'Get subscription renewal tracker' })
